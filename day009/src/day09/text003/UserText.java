 ...
 *         - 继承 
 *         - 多态 
 * 	 当前主要讲解的是封装机制。为什么要封装？封装有什么好处？ 封装的好处：
 ...
 *
 *	3、封装就意味着以后的程序可以重复使用，并且这个事物应该适应性比较强，在任何场合可以使用。
 *
...
public class UserText {
	...
	public static void main(String[] args) {
		...
		// 读取年龄值【get】
		// eclipse快捷鍵：ctrl + shift +f 格式化
		System.out.println("该用户年龄：" + user.age);

		// 修改年龄值
		//这里的age属性显然是完全暴露给外部程序的，对于程序员来说
		//可以操作User对象当中的所有的细节，导致User中部分数据不安全
		//不建议这样，建议User类是进行封装，建议在外部程序中不能随意访问User
		//对象当中的属性。这样可以保证User属性的安全。
		user.age = -100;
